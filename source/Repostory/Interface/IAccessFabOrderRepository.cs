...
namespace MOD4.Web.Repostory
{
    ...
    {
        List<AccessFabOrderDao> SelectList(int orderSn = 0, string orderNo = "", int statusId = 0, int fabInTypeId = 0, string applicant = "", int applicantAccountSn = 0, int auditAccountSn = 0, DateTime? startTime = null, DateTime? endTime = null);
